...
backend_env_path = os.path.join(os.path.dirname(__file__), '..', '..', '..', 'application', 'backend', '.env')
...
def main():
    ...
    # Save with efficient storage
    embeddings_file, data_file = save_embeddings_efficiently(df, '../Data/ideas_with_diversity_scores')
    
    # Also save traditional CSV for compatibility (without embeddings)
    output_file = '../Data/ideas_with_diversity_scores.csv'
